...
// const img4=document.getElementById('img1');
// const img5=document.getElementById('img1');
// const img6=document.getElementById('img1');
// const img7=document.getElementById('img1');
// const img8=document.getElementById('img1');
...
// allImgs[0].addEventListener
// {'click',function(event){
//   current.src=event.target.src;
// }};

// allImgs[1].addEventListener
// {'click',function(event){
//   current.src=event.target.src;
// }};

// allImgs[2].addEventListener
// {'click',function(event){
//   current.src=event.target.src;
// }};


// allImgs[3].addEventListener
// {'click',function(event){
//   current.src=event.target.src;
// }};


// allImgs[4].addEventListener
// {'click',function(event){
//   current.src=event.target.src;
// }};


// allImgs[5].addEventListener
// {'click',function(event){
//   current.src=event.target.src;
// }};


// allImgs[6].addEventListener
// {'click',function(event){
//   current.src=event.target.src;
// }};


// allImgs[7].addEventListener
// {'click',function(event){
//   current.src=event.target.src;
// }};
